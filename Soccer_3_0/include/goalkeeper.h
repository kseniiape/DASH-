...
void line_goal_ball()
{
    ...
    y = sqrt(y2) +goalkeeper::line_ball_goal::y_center;
    /*Serial.print(' ');
    Serial.print(y);
    Serial.print(' ');*/
    /*double y2 = (goalkeeper::R * goalkeeper::R ) - ((robot::x - goal::our::x) * (robot::x - goal::our::x));
    ...
    static double err_old_y = err_y, err_i_y = 0;
    ...
    static double err_old_x = err_x, err_i_x = 0;
    ...
    move_angle_speed(goalkeeper::angle , goalkeeper::speed, ball::angle + robot::local_angle);

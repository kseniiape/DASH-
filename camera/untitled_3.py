...
if robot == 2:
    ...
    EXPOSURE_TIME_SCALE = 1.9

    yellow_threshold = [(0, 100, -15, 127, 14, 127)]
    blue_threshold = [(15, 18, -128, -12, -128, 4)]
    exposure = 12_000
    gain = 35
    center  = [166, 121]
    white = (63, 60, 63)
    ...
    yellow_threshold = [(0, 100, -128, 127, 24, 127)]
    blue_threshold = [(0, 100, -128, 127, -128, -32)]
    exposure = 50_000
    gain = 50
    center  = [165,103]
    white = (62, 60, 62)
...
while True:
    ...
    for blob in img.find_blobs(yellow_threshold, pixels_threshold=48, area_threshold=195, merge=True, margin = 20):
    ...
    for blob in img.find_blobs(blue_threshold, pixels_threshold=48, area_threshold=195, merge=True, margin = 20):
        if(blob[2] * blob[3] > old_area and blob[2] * blob[3] > 60):
            old_area = blob[2] * blob[3]
